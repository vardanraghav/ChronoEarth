    ...
    >
      ...
      <div
        style={{
          ...
          color:        earthMode === 'cyber' ? 'rgba(0, 229, 255, 0.60)' : statusColor,
          marginBottom: '8px',
          textShadow:   earthMode === 'cyber' ? '0 0 10px rgba(0, 229, 255, 0.40)' : 'none',
        }}
      >
        {activeCity ? activeCity.name.toUpperCase() : activeCategory.toUpperCase()}
        <span style={{ margin: '0 8px', color: earthMode === 'cyber' ? 'rgba(0, 229, 255, 0.15)' : 'rgba(255,255,255,0.15)' }}>·</span>
        {content.status}
      </div>
      ...
      <p
        style={{
          ...
          fontWeight:    300,
          lineHeight:    1.7,
          color:         earthMode === 'cyber' ? 'rgba(0, 229, 255, 0.50)' : 'rgba(255,255,255,0.42)',
      ...
      >
        <div
          style={{
            ...
            background: earthMode === 'cyber' ? 'rgba(0, 229, 255, 0.60)' : 'rgba(255,255,255,0.35)',
            transition: 'width 1.2s cubic-bezier(0.22, 1, 0.36, 1)',
            borderRadius: '1px',
            boxShadow: earthMode === 'cyber' ? '0 0 6px rgba(0, 229, 255, 0.70)' : 'none',
          }}
        />
      </div>
      {/* Stability label */}
      <div
        style={{
          ...
          color:         earthMode === 'cyber' ? 'rgba(0, 229, 255, 0.25)' : 'rgba(255,255,255,0.18)',
          textTransform: 'uppercase',
          transition:    'color 0.6s ease',
        }}
      >
