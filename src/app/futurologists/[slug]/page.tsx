        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 flex flex-col gap-6">
            <div style={panelStyle} className="flex flex-col gap-6">
              ...
              <div className="border-t border-[#00F5B0]/60 pt-4 flex flex-col gap-3 font-mono text-xs">
                <div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-1">
                    <div className="flex-1 h-2 bg-[#040B12] border border-[#00F5B0]/20 rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-gradient-to-r from-cyan-400 to-[#00F5B0] rounded-full shadow-[0_0_6px_#00F5B0]"
              ...
              <div className="border-t border-[#00F5B0]/60 pt-4 text-sm text-slate-300 leading-relaxed font-sans">
              ...
              <div className="flex flex-col gap-5">
                {authorPredictions.length === 0 ? (
                  ...
                  authorPredictions.map(p => (
                    <div 
                      key={p.id}
                      className="p-4 bg-[#00F5B0]/5 border border-[#00F5B0]/40 rounded flex flex-col gap-3 hover:border-[#00F5B0]/30 transition-colors"
                    >
                      <div className="flex justify-between items-center text-[10px] font-mono">
                        <div className="flex gap-2">
                          ...
                          <span className="px-2 py-0.5 bg-[#040B12] text-[#00F5B0] border border-emerald-500/20 uppercase tracking-wider rounded-sm">{p.year} FORECAST</span>
                        </div>
                      ...
                      <div className="flex justify-between items-center border-t border-[#00F5B0]/20 pt-3 text-[10px] font-mono text-[#7A8694]">
