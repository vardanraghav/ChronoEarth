...
const createSampleComments = (title: string): Comment[] => [
  {
    ...
    author: 'Aura_Observer',
    content: `This projection for ${title} seems highly probable given the current rate of technological convergence. However, systemic risks remain.`,
    ...
    replies: [
      {
        ...
        author: 'Dr_Kowalski',
        content: 'Agreed. The primary bottleneck isn\'t the core science, but international policy alignment.',
  ...
  },
  {
    ...
    author: 'Nexus_Forecaster',
    content: 'We need to factor in localized supply chain disruptions when calculating the implementation timeline.',
